    ...
    <div className=''>
      ...
      ? (<div className="">
        ...
        <div className="relative">
          ...
          <h3 className='font-dm lg:text-[16px] text-[8px] flex items-center justify-end gap-2 py-2 pr-2 hover:font-bold cursor-pointer '>Add to Wish List < FaHeart/></h3>
          <h3 className='font-dm lg:text-[16px] text-[8px] flex items-center justify-end gap-2 py-2 pr-2 hover:font-bold cursor-pointer'>Compare<LuRefreshCcw/></h3>
          <h3 className='font-dm lg:text-[16px] text-[8px] flex items-center justify-end gap-2 py-2 pr-2 hover:font-bold cursor-pointer'>Add to Cart <FaCartShopping/></h3>
          </div>
          <div className="font-dm lg:text-[16px] text-[10px] bg-[#262626] py-1 lg:px-3 px-1 absolute lg:top-[15px] lg:left-[15px] top-[5px] left-[5px] text-[#FFFFFF]">
           {item.discountPercentage}%
          </div>
        </div>
        <div className=" lg:py-5">
          <div className="flex justify-between ">
            <h3 className='font-dm lg:text-[16px] text-[10px]'>{item.title}</h3>
            <h2 className='font-dm lg:text-[16px] text-[10px] text-[#767676]'>${item.price}</h2>
          </div>
      ...
      :(<div className={`${active == "active" ? "w-full" : "flex flex-wrap"}`}>
          {allPage.map((item)=>(
        <div className='lg:w-1/3 w-1/2 p-3 relative'>
        <div className="relative">
          <Link to={`/Shop/${item.id}`}>
          ...
          <div className="font-dm lg:text-[16px] text-[8px] bg-[#262626] py-1 lg:px-3 px-1 absolute lg:top-[15px] lg:left-[15px] top-[5px] left-[5px] text-[#FFFFFF]">
           {item.discountPercentage}%
          </div>
        </div>
        <div className=" lg:py-5">
